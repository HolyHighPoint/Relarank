...
/// \file node.h
///
/// \brief Contains the definition of the relarank::Node class and relarank::NodeExpansion enum.
///
...
signals:
    ...
    ///
    /// \brief Emitted, when the \ref relarank::View::s_activationKey "activation key" is pressed while this Node is
    /// selected.
    ///
    void nodeActivated();
    ...
    ///
    /// \brief Emitted, when the \ref relarank::View::s_removalButton "removal button" is pressed on this Node.
    ///
...
protected: // methods
    ...
    ///
    /// Is always called after \ref relarank::Node::mousePressEvent "mousePressEvent" and possibly
    /// \ref relarank::Node::mouseMoveEvent "mouseMoveEvent".
    ///
    /// \param [in] event   Qt event object.
    ///
...
private: // members
    ...
    ///
    /// \brief The last expansion state (to return to from \ref relarank::NodeExpansion::BOTH "NodeExpansion::BOTH").
    ///
