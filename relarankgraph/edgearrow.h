...
/// \file edgearrow.h
///
/// \brief Contains the definition of the relarank::EdgeArrow class and relarank::ArrowKind enum.
///
...
///
/// It is placed at the middle of the BaseEdge and comes in two flavors: \ref relarank::ArrowKind::SINGLE "single" and
/// \ref relarank::ArrowKind::DOUBLE "double".
///
...
public: // static methods
    ...
    ///
    /// Is used for the calculation of the \ref relarank::ArrowKind::SINGLE "single" and \ref relarank::ArrowKind::DOUBLE
    /// "double"  arrow.
    ///
...
private: // members
    ...
    ///
    /// \brief The kind of this EdgeArrow, defaults to \ref relarank::ArrowKind::SINGLE "single".
    ///
    ArrowKind m_kind;
...
private: // static members
    ...
    ///
    /// \brief Size of the gap between the two lines of a \ref relarank::ArrowKind::DOUBLE "double" arrow.
    ///
    ...
    ///
    /// \brief Original \ref relarank::ArrowKind::SINGLE "single" arrow.
    ///
    ...
    ///
    /// \brief Original \ref relarank::ArrowKind::DOUBLE "double" arrow.
    ///
    /// Is shared by all edge arrows as base for their own.
    ///
