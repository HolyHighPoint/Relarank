...
/// \file bezieredge.h
///
/// \brief Contains the definition of the relarank::BezierEdge class.
///
...
/// direction of the Plug's normal until they have reached the \ref relarank::BezierEdge::s_maxCtrlDistance
...
/// "S-shapes".
///
/// The ratio between arclength and expansion is controlled using the \ref relarank::BezierEdge::s_ctrlExpansionFactor
