...
/// \file plughandle.h
///
/// \brief Contains the definition of the relarank::PlugHandle class.
///
...
///
/// \brief A handle object for a relarank::Plug.
///
...
///
inline uint qHash(const relarank::PlugHandle& key)
{
