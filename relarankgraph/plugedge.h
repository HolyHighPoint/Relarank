...
/// \file plugedge.h
///
/// \brief Contains the definition of the relarank::PlugEdge class.
///
...
public: // methods
    ...
    ///
    /// \brief The start Plug of this PlugEdge is an \ref relarank::PlugDirection::OUT "outgoing" Plug of a Node.
    ///
    ...
    ///
    /// \brief The end Plug of this PlugEdge is an \ref relarank::PlugDirection::IN "incoming" Plug of a Node.
    ///
