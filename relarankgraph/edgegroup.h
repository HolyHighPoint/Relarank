...
/// \file edgegroup.h
///
/// \brief Contains the definition of the relarank::EdgeGroup class.
///
...
public: // methods
    ...
    ///
    /// See \ref relarank::EdgeGroup::increaseBentCount() "increaseBentCount()" for details on bent edges.
    ///
    ...
    ///
    /// \brief The hash of this EdgeGroup, as calculated by \ref relarank::EdgeGroup::getHashOf() "getHashOf()".
    ///
