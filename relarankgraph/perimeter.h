...
/// \file perimeter.h
///
/// \brief Contains the definition of the relarank::Perimeter class.
///
...
public: // methods
    ...
    /// See \ref relarank::Perimeter::setMinRadius() "setMinRadius()" for details.
    ///
...
protected: // methods
    ...
    ///
    /// Is always called after \ref relarank::Perimeter::mousePressEvent "mousePressEvent" and possibly
    /// \ref relarank::Perimeter::mousePressEvent "mousePressEvent".
    ///
    /// \param [in] event   Qt event object.
    ///
