...
/// \file scenehandle.h
///
/// \brief Contains the definition of the relarank::SceneHandle class.
///
...
public: // methods
    ...
    ///
    /// \brief Creates and adds a new Node to the relarank graph.
    ///
...
///
inline uint qHash(const relarank::SceneHandle& key)
{
