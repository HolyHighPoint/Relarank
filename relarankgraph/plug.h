...
/// \file plug.h
///
/// \brief Contains the definition of the relarank::Plug class and relarank::PlugDirection enum.
///
...
public: // methods
    ...
    /// See \ref relarank::Node::arrangePlugs() "Node::arrangePlugs()" for details.
    ///
    ...
    /// the \ref relarank::Node::arrangePlugs "Plug arrangement".
    ///
...
public: // static methods
    ...
    /// \ref relarank::NodeExpansion::OUT "OUT" after connecting an incoming PlugEdge or not.
    ///
    ...
    ///
    /// \brief Defines, whether the target Node's expansion state is changed to \ref relarank::NodeExpansion::OUT "OUT"
...
protected: // methods
    ...
    ///
    /// Is always called after \ref relarank::Plug::mousePressEvent "mousePressEvent" and possibly
    /// \ref relarank::Plug::mousePressEvent "mousePressEvent".
    ///
    /// \param [in] event   Qt event object.
    ///
...
private: // methods for friends
    ...
    ///
    /// Must only be called by relarank::Node::togglePlugDirection().
    ///
    ...
    ///
    /// Must only be called by relarank::Node::renamePlug.
    ///
