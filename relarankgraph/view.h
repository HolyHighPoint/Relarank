...
/// \file view.h
///
/// \brief Contains the definition of the relarank::View class.
///
...
///
/// \brief The relarank namespace.
///
/// All classes, functions and enums are part of the relarank-namespace to keep them separated from whatever else is used
/// in the project.
///
namespace relarank {
...
public: // methods
    ...
    ///
    /// Reimplemented to force a relarank::Scene to be viewed instead of a generic QGraphicsScene.
    ///
