...
/// \file drawedge.h
///
/// \brief Contains the definition of the relarank::DrawEdge class.
///
...
public:
    ...
    ///
    /// \brief Reverses the display of the DrawEdge to accomodate drawing from an \ref relarank::PlugDirection::IN
    /// "incoming" Plug.
    ///
    /// \param [in] isReverse   <i>true</i> if the DrawEdge originates at an \ref relarank::PlugDirection::IN "incoming"
    /// Plug -- <i>false</i> otherwise.
    ///
    inline void setReverse(bool isReverse){m_isReverse=isReverse;}

    ///
    /// \brief The DrawEdge is said to be <i>reversed</i>, if it originates in an \ref relarank::PlugDirection::IN
...
private: // members
    ...
    ///
    /// \brief <i>true</i> if this DrawEdge originates in a \ref relarank::PlugDirection::IN "incoming" Plug.
    ///
    bool m_isReverse;
